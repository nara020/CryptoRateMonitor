...
def calculate_metrics(symbol):
    ...
    lowest_price_all_time = round(float(lowest_all_time[3]), 2)
    ...
    metrics = {
        ...
        "lowest_price_all_time": format_number(lowest_price_all_time),
        ...
        "percentage_increase_pre_2023": calculate_percentage(highest_price_pre_2023, lowest_price_all_time) if highest_price_pre_2023 else None,
